<template>
  <v-container>
    ...
    <v-row class="mb-2">
      <v-col>
      {{$t('This includes: Journal articles, reports, reviews, working papers, conference papers ...')}}
      </v-col>
    </v-row>
    ...
    <v-row class="mb-2">
      <v-col>
      {{$t('This includes: Individual chapters from monographs, collections of essays, conference proceedings ...')}}
      </v-col>
    </v-row>
    <v-divider class="my-2"></v-divider>
    <v-row>
    ...
    <v-row class="mb-2">
      <v-col>
      {{$t('This includes: Complete monographs, collections of essays, conference proceedings ...')}}
      </v-col>
    </v-row>
  </v-container>
</template>
