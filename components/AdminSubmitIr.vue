        ...
        if(doiAgency === 'datacite'){
          ...
          this.doiImportData = {
            ...
            if(dataciteData?.data?.attributes?.titles?.length){
              this.doiImportData.title = dataciteData.data.attributes.titles[0].title
            }
            if(dataciteData?.data?.attributes?.publicationYear){
              this.doiImportData.dateIssued = dataciteData?.data?.attributes?.publicationYear
            }
            ...
            if (dataciteData?.data?.attributes?.language) {
              if (this.lang2to3map[dataciteData.data.attributes.language]) {
                this.doiImportData.language = this.lang2to3map[dataciteData.data.attributes.language]
              }
            }
            ...
            if(dataciteData?.data?.attributes?.publisher){
              this.doiImportData.publisher = this.$_.unescape(dataciteData.data.attributes.publisher.replace(/\s\s+/g, ' ').trim())
            }
            ...
            if(dataciteData?.data?.attributes?.container?.title) {
              this.doiImportData.journalTitle = this.$_.unescape(dataciteData?.data?.attributes?.container?.title.replace(/\s\s+/g, ' ').trim())
            }
          // this.resetForm(this, this.doiImportData)
          return
        }
