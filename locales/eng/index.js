...
export default {
  ...
  SUBMIT_START_1: 'All University affiliates are invited to upload their academic publications to u:scholar, the University\'s institutional repository. Details can be found in our {0}.',
  ...
  SUBMIT_ATTENTION: 'According to the legal terms & conditions listed in Open policy finder it might not be permitted to upload articles from {journal} as {version} to the instutional repository u:scholar. Please check your upload and, if necessary, choose a version where this is allowed. In case the publisher explicitly granted you the right to upload the published version please let us know in writing via',
  OTHER_FEMININE: 'Other',
  ABOUT_LINK: 'About {name}',
  ERROR_AFFILIATION: 'At least one person named must be affiliated with {institution}',
  'Not available via {name}': 'Not available via {name}',
  'Not publicly available via {name}': 'Not publicly available via {name}',
  'Not available via {name} until {embargoEnd}': 'Not available via {name} until {embargoEnd}',
  ...
  'LICENSE_DISCLAIMER': '<p><b>Disclaimer:</b> The service provider (PHAIDRA, {institution}) and Creative Commons are not party to the licence agreement. No rights or obligations will originate such that would be deemed binding to either the service provider or Creative Commons. The service provider is especially not obliged to verify the correctness of your chosen licence and assumes no liability whatsoever for the legality of your content. Neither the service provider nor Creative Commons is defined as a law practice, and cannot and will not furnish legal advice. Said parties provide the information found here without any assumed warranty and assume no liability for any damages that could arise from its use.</p><p>In case of an initial licensing the following applies in addition to the above: Your action to legally offer your protected object within a Creative Commons licence and the acceptance of said offer by third parties establishes a contractual relationship between you and the respective user. Neither the service provider nor the Creative Commons is party to this contractual relationship. The choice of licence is solely your reponsibility.</p>'
}
